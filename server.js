...
server.post("/create-blog", verifyJWT, (req, res) => {
  ...
  if (isAdmin) {
    ...
    if (id) {
      ...
      console.log("purpose of visit mil gua hai :", purpose_of_visit);
...
server.post("/get-blog", (req, res) => {
  ...
  Blog.findOneAndUpdate(
    ...
    .select(
      "title location purpose_of_visit cpfnumber des content banner activity publishedAt blog_id tags"
    )
    .then((blog) => {
      User.findOneAndUpdate(
